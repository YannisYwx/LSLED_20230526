...
public class CirclePointIndicatorView extends LinearLayout {
    ...
    public CirclePointIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxHeight = dpToPx(context, mHeight);
        mNormalBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.indicator_point_nomal);
        mSelectBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.indicator_point_select);
    }
